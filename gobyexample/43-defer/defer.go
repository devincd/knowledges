...
cleanup. defer is often used where e.g. ensure and
...
func main() {
	// suppose we wanted to create a file, write to it, and then
	// close when we're done. Here's how we could do that with
	// defer.
...
// It's important to check for errors when closing a file, even
...
/*
Running the program confirms that the file is closed after
being written.
