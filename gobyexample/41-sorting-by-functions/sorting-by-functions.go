...
// On order to sort by a custom function in Go, we need a
...
// function. Len and Swap will usually be similar across types
// and Less will hold the actual custom sorting logic. In our
// case we want to sort in order of increasing string length, so
...
// custom sort by converting the original fruits slice to
...
/*
Running our program shows a list sorted by string length,
as desired.
