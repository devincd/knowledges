...
external resources or otherwise need to bound
...
func main() {
	...
	// nonblocking. This is a common pattern to prevent
	...
	// send after the timeout of 1s. Since select proceeds with
	...
	// If we allow a longer timeout if 3s, the receive from c2
