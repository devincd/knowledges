...
erros and to handle them using the same language
...
// variant on the example above that uses a custom type to
...
func f2(arg int) (int, error) {
	if arg == 42 {
		// In thia case we use &argError syntax to build a new struct,
		// supplying values the two fields arg and prob.
...
func main() {
	...
	// error, you'll need to get the errors as an instance of the
